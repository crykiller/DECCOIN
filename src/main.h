...
public:
    ...
    {
        // Digitaleurasia: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Digitaleurasia: get transaction coin age
...
public:
    ...
    // Digitaleurasia: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Digitaleurasia: two types of block: proof-of-work or proof-of-stake
    ...
    // Digitaleurasia: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Digitaleurasia: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Digitaleurasia: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Digitaleurasia: block index flags
    enum  
    {
