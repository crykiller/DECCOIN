Copyright (c) 2014 Digitaleurasia Developers <br />
...
See readme-qt.rst for instructions on building Digitaleurasia QT, the
...
DOS prompt:
    ...
    cd \Digitaleurasia\src
    mingw32-make -f makefile.mingw
    strip Digitaleurasiad.exe
